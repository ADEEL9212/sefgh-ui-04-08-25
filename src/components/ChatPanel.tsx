      ...
      <div className="p-4">
        <form onSubmit={handleSubmit} className="relative">
          ...
          {showToolsMenu && <div className="tools-menu-container relative">
              <div className="mb-3 bg-gray-900 dark:bg-gray-800 text-white rounded-xl shadow-2xl p-4 border border-gray-700" style={{
            boxShadow: '0 8px 24px rgba(0,0,0,0.2)'
                ...
                setShowToolsMenu(false);
                  ...
                  {/* More menu */}
                  <div className="flex items-center justify-between gap-3 p-3 rounded-lg hover:bg-gray-700 dark:hover:bg-gray-600 cursor-pointer transition-all duration-150 relative" onMouseEnter={() => setShowMoreMenu(true)} onMouseLeave={() => setShowMoreMenu(false)}>
                    ...
                    {showMoreMenu && <div className="absolute left-full top-0 ml-2 bg-gray-900 dark:bg-gray-800 text-white rounded-xl shadow-2xl p-4 w-48 z-50" style={{
                  boxShadow: '0 8px 24px rgba(0,0,0,0.2)'
                }}>
                        <div className="space-y-1">
                          {/* Web Search */}
          ...
          <div className="bg-card border-2 border-border focus-within:border-ring rounded-xl px-4 py-3 flex items-center gap-3 transition-colors">
            ...
            {/* Input field */}
            <ExpandablePromptInput ref={inputRef} value={input} onChange={setInput} placeholder="Ask anything" className="flex-1 bg-transparent border-none text-slate-200 placeholder:text-slate-500 focus:outline-none" onKeyDown={e => {
